    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary">Data Pengunjung</h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $d->no_hp; ?></td>
                                    <td>
                                        <a href="<?= base_url('lapor/editI/' . $d->id); ?>" class="btn btn-success btn-sm">Edit</a>
                                        <a href="<?= base_url('lapor/deleteI/' . $d->id); ?>" onclick="return confirm('Yakin mau menghapus?')" class="btn btn-danger btn-sm">Delete</a>
